...
export default () => {
  return (
    <>
      ...
      <div>
        <div
          className="cw-jumb jumbotron bg-blue text-white m-0"
          style={{
        ...
        >
          <div className="jumbo-text">
            ...
            <p className="text-white jumb-body">
              Join our market place and get your medical supplies easily, trust-based and see what is happening in the marketplace NOW!
            </p>
            <div>
              {/* <hi */}
          ...
          <div className="container text-center">
            ...
            <div className="row">
              <div className="col-md-4">
                <div
                  className="why-card card mb-4 shadow-sm border border-secondary cw-why-us-card"
                  style={{ height: '250px', width: '250px' }}
                >
                  <div className="card-body ">
                    <p className="card-text bg-white" style={{ position: 'absolute', right: '-20px', top: '40%' }}>
                      Trust
                    </p>
                  </div>
                </div>
          ...
          <div className="container-fluid">
            <div>
              <p className="about-us-text">
                We are a medical supply marketplace designed to disrupt the current medical supply chain using advanced analytics to
                efficiently and dynamically match supply and demand to ensure we never have the shortage of 2020 again..
              </p>
            </div>
