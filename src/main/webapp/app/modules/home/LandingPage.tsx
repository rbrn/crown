                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3 ">
                            ...
                            <ul className="list-unstyled text-small footer-right">
                                <li><Link className="text-muted text-gray-1" to="#">Email: info@needmoremed.com</Link></li>
                                <li><Link className="text-muted text-gray-1" to="#">Address: Toronto, Canada</Link></li>
                                <li><Link className="text-muted text-gray-1" to="#">Terms and Policy</Link></li>
                            </ul>
                        </div>
                    </div>
                </footer>
