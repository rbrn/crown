  ...
  render() {
    ...
    return (
       <div style={{ backgroundImage:`url('../../../content/images/background.png')` }}>
            <br/><br/><br/><br/>
            <Row>
            <Col span={24} style={{textAlign:"center"}}><h5 style={titleText}>Get ready to supply</h5></Col>
            </Row>
            <br/><br/>
            <div>
     <Row>
      ...
      <br />
      <p style={innerBottomBox}><h6 style={innerBottomBoxText}>CURRENT DEMAND</h6></p>
      </Col>
      <Col span={2}></Col>
      <Col span={4} style={outerBoxStyles} className="shadow p-3 mb-5 bg-blue rounded">
      ...
      <br />
      <p style={innerBottomBox}><h5 style={innerBottomBoxText}>LIST SUPPLIES</h5></p>
      </Col>
          <Col span={2}></Col>
          <Col span={4} style={outerBoxStyles} className="shadow p-3 mb-5 bg-blue rounded">
      ...
      <p style={innerParagraph}><span style={innerParagraphText}>Lorem ipsum dolor sit amet, consetetur sadip scing elitr, sed diam nonumy</span></p>
      <br />
      <p style={innerBottomBox}><h5 style={innerBottomBoxText}>FUTURE DEMAND</h5></p>
      </Col>
          <Col span={4}></Col>
    </Row>
  </div>
