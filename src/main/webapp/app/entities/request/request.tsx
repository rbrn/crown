...
import { getSearchEntities, getEntities } from './request.reducer';
  ...
  return (
    <div>
      <h2 id="request-heading">
        <Translate contentKey="crownApp.request.home.title">Requests</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="crownApp.request.home.createLabel">Create new Request</Translate>
        </Link>
      </h2>
      <Row>
        <Col sm="12">
            ...
            <AvGroup>
              <InputGroup>
                <AvInput
                  ...
                  placeholder={translate('crownApp.request.home.search')}
                />
        ...
        {requestList && requestList.length > 0 ? (
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="crownApp.request.home.notFound">No Requests found</Translate>
            </div>
          )
        )}
      </div>
