...
export const SupplyPointUpdate = (props: ISupplyPointUpdateProps) => {
  ...
  const handleClose = () => {
    props.history.push('/supply-point' + props.location.search);
  };
        ...
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : supplyPointEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="latitudeLabel" for="supply-point-latitude">
                  <Translate contentKey="crownApp.supplyPoint.latitude">Latitude</Translate>
                </Label>
                <AvField id="supply-point-latitude" type="string" className="form-control" name="latitude" />
              </AvGroup>
              <AvGroup>
                <Label id="longitudeLabel" for="supply-point-longitude">
                  <Translate contentKey="crownApp.supplyPoint.longitude">Longitude</Translate>
                </Label>
                <AvField id="supply-point-longitude" type="string" className="form-control" name="longitude" />
              </AvGroup>
              <AvGroup>
              ...
              <AvGroup>
                <Label id="emailLabel" for="supply-point-email">
                  <Translate contentKey="crownApp.supplyPoint.email">Email</Translate>
                </Label>
                <AvField id="supply-point-email" type="text" name="email" />
              </AvGroup>
              <AvGroup check>
