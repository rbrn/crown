...
describe('Entities reducer tests', () => {
  ...
  describe('Requests', () => {
    ...
    it('should set state to updating', () => {
      testMultipleTypes(
        [
          REQUEST(ACTION_TYPES.CREATE_RECEIVERRESOURCE),
          REQUEST(ACTION_TYPES.UPDATE_RECEIVERRESOURCE),
          REQUEST(ACTION_TYPES.DELETE_RECEIVERRESOURCE)
        ],
        {},
        state => {
          expect(state).toMatchObject({
    ...
    it('should set a message in errorMessage', () => {
      testMultipleTypes(
        [
          ...
          FAILURE(ACTION_TYPES.DELETE_RECEIVERRESOURCE)
        ],
        'error message',
        state => {
          expect(state).toMatchObject({
  ...
  describe('Successes', () => {
    ...
    it('should fetch a single entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.FETCH_RECEIVERRESOURCE),
          payload
        })
      ).toEqual({
        ...initialState,
    ...
    it('should create/update entity', () => {
      ...
      expect(
        reducer(undefined, {
          type: SUCCESS(ACTION_TYPES.CREATE_RECEIVERRESOURCE),
          payload
        })
      ).toEqual({
        ...initialState,
    ...
    it('should delete entity', () => {
      ...
      const toTest = reducer(undefined, {
        type: SUCCESS(ACTION_TYPES.DELETE_RECEIVERRESOURCE),
        payload
      });
  ...
  describe('Actions', () => {
    ...
    it('dispatches ACTION_TYPES.FETCH_RECEIVERRESOURCE_LIST actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_RECEIVERRESOURCE_LIST)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_RECEIVERRESOURCE_LIST),
    ...
    it('dispatches ACTION_TYPES.FETCH_RECEIVERRESOURCE actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.FETCH_RECEIVERRESOURCE)
        },
        {
          type: SUCCESS(ACTION_TYPES.FETCH_RECEIVERRESOURCE),
          payload: resolvedObject
    ...
    it('dispatches ACTION_TYPES.CREATE_RECEIVERRESOURCE actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.CREATE_RECEIVERRESOURCE)
        },
        {
          type: SUCCESS(ACTION_TYPES.CREATE_RECEIVERRESOURCE),
          payload: resolvedObject
    ...
    it('dispatches ACTION_TYPES.UPDATE_RECEIVERRESOURCE actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.UPDATE_RECEIVERRESOURCE)
        },
        {
          type: SUCCESS(ACTION_TYPES.UPDATE_RECEIVERRESOURCE),
          payload: resolvedObject
        }
      ];
    ...
    it('dispatches ACTION_TYPES.DELETE_RECEIVERRESOURCE actions', async () => {
      const expectedActions = [
        {
          type: REQUEST(ACTION_TYPES.DELETE_RECEIVERRESOURCE)
        },
        {
          type: SUCCESS(ACTION_TYPES.DELETE_RECEIVERRESOURCE),
          payload: resolvedObject
