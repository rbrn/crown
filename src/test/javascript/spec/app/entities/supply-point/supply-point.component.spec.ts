...
import { SupplyPointComponent } from 'app/entities/supply-point/supply-point.component';
...
describe('Component Tests', () => {
  describe('SupplyPoint Management Component', () => {
    let comp: SupplyPointComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SupplyPointComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.supplyPoints && comp.supplyPoints[0]).toEqual(jasmine.objectContaining({ id: '123' }));
    });
