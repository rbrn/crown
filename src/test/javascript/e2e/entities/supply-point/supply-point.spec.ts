...
describe('SupplyPoint e2e test', () => {
  ...
  it('should create and save SupplyPoints', async () => {
    ...
    await supplyPointUpdatePage.setLatitudeInput('5');
    expect(await supplyPointUpdatePage.getLatitudeInput()).to.eq('5');
    await supplyPointUpdatePage.setLongitudeInput('5');
    expect(await supplyPointUpdatePage.getLongitudeInput()).to.eq('5');
    ...
    await supplyPointUpdatePage.setEmailInput('email');
    expect(await supplyPointUpdatePage.getEmailInput()).to.match(/email/);
